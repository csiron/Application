...
$status =0;
$issubscribed=0;
mysqli_query($link, 'INSERT INTO comments (ID, uname, email, phone, raws3URL,finisheds3URL,filename,state,date) VALUES (NULL, '$uname', '$email', '$phone', '$s3rawurl', '$s3finishedURL', '$filename', '$s3finishedURL', '$status', NULL)");
